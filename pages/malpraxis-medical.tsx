...
const page = () => {
    ...
    return (<>
        ...
        >
            ...
            <p> Inainte de toate, trebuie avut in vedere ca personalul medical are o obligatie de mijloace: trebuie sa depuna toate diligentele necesare si posibile pentru a trata pacientul.</p>
            <Alert variant={'info'}>
                <cite>
            ...
            <p>Mai exact, adauga specialistul, pentru primul pas (stabilirea existentei unui caz de malpraxis), legea sanatatii ne ofera doua variante alternative: fie sesizarea Comisiei de monitorizare si competenta profesionala pentru cazurile de malpraxis, fie sesizarea directa a instantei de judecata. </p>
