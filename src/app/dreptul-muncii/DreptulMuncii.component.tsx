...
const DreptulMunciiComponent = () => {
  ...
  const argumenteSedinteDeMediere = [
  ...
  return (
    <SecondaryPage
      parallaxURL={"secondaryPage/muncii.jpg"}
      ...
      <Accordion defaultActiveKey="0" className="text-dark">
          ...
          >
            <div>
              ...
              <h2 className="h6">
                ...
                munca ivite intre angajator si salariat privitoare la contractul
                individual de munca dar si consultanta juridica cu privire la:
              </h2>
            </div>
          </Accordion.Header>
        ...
        <Accordion.Item eventKey="1">
          ...
          >
            <div>
              <h6 className="text-secondary">
                Pe parcursul desfasurarii contractului individual de munca sau
                dupa incheierea acestuia oferim
              </h6>

              <h2 className="h6">
                ✅ Asistenta juridica si reprezentarea clientilor in litigiile
                de munca privitoare la{" "}
...
export default DreptulMunciiComponent;
