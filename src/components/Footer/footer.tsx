          ...
          <main className="container">
            <main className="grid-container">
              ...
              <main className="grid-item inner-grid-container">
                ...
                <main className="grid-item">
                  <a href="/avocat-online">Avocat Online</a>
                </main>
                <main className="grid-item">
                ...
                <main className="sso">
                  ...
                  <a href="https://wa.me/+40744312032">
                    <svg
                      ...
                      data-prefix="fab"
                      data-icon="whatsapp"
                      className="circle-icon svg-inline--fa fa-whatsapp fa-w-14"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                    >
                  ...
                  <a href="https://www.facebook.com/avocatdorubotea">
                    <svg
                      ...
                      data-prefix="fab"
                      data-icon="facebook"
                      className="circle-icon svg-inline--fa fa-facebook fa-w-16"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                    >
                  ...
                  <a href="mailto:avocat.dorubotea@gmail.com">
                    <svg
                      ...
                      data-prefix="far"
                      data-icon="envelope"
                      className="circle-icon svg-inline--fa fa-envelope fa-w-16"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                    >
